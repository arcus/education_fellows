...
<figure style = "border: 1px solid rgb(var(--color-border))">
  <img src="https://github.com/arcus/education_fellows/blob/joy-clicktoplay/img/rstudio.png?raw=true" alt="R.app, or the R Console" data-alt="https://github.com/arcus/education_fellows/blob/main/img/rstudio.gif?raw=true">
